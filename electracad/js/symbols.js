...
const SYMBOLS = [
  ...
  {
    id: "limit_sw", cat: "input", letter: "S", name: "リミットスイッチ", nameEn: "Limit switch",
    desc: "ローラレバー・a接点", pins: [{x:0,y:0,n:"13"},{x:0,y:20,n:"14"}],
    sim: "contact_no", momentary: false, bounds: [-19,-2, 22, 24],
    body: G_NO + `<path d="M-10,14 L-15,6"/><circle cx="-15.8" cy="4.6" r="1.7"/><path d="M-10,14 H-10" /><path d="M-10,14 L-3,14" stroke-dasharray="1.6 1.6" transform="translate(0,-4)"/>`,
  },
  {
    id: "prox", cat: "input", letter: "B", name: "近接センサ", nameEn: "Proximity sensor",
    desc: "誘導形・NPN/PNP", pins: [{x:0,y:0,n:"BK"},{x:0,y:20,n:"BU"}],
  ...
  },
  {
    ...
    desc: "透過形/反射形", pins: [{x:0,y:0,n:"BK"},{x:0,y:20,n:"BU"}],
    sim: "contact_no", momentary: false, bounds: [-20,0, 24, 20],
  ...
  },
  {
    ...
    desc: "設定圧で動作・a接点", pins: [{x:0,y:0,n:"13"},{x:0,y:20,n:"14"}],
  ...
  },
  {
    ...
    desc: "液面レベル検出", pins: [{x:0,y:0,n:"13"},{x:0,y:20,n:"14"}],
    sim: "contact_no", momentary: false, bounds: [-19,-2, 22, 24],
  ...
  },
  {
    ...
    desc: "温度スイッチ・b接点", pins: [{x:0,y:0,n:"11"},{x:0,y:20,n:"12"}],
  ...
  /* ══════════ ロジック機器 ══════════ */
  {
    ...
    desc: "補助リレー A1-A2", pins: [{x:0,y:0,n:"A1"},{x:0,y:20,n:"A2"}],
    sim: "coil", bounds: [-7,0, 14, 20], mirror: true,
  ...
  },
  {
    ...
    desc: "主回路開閉用 A1-A2", pins: [{x:0,y:0,n:"A1"},{x:0,y:20,n:"A2"}],
    sim: "coil", bounds: [-7,0, 14, 20], mirror: true,
    body: `<path d="M0,0 V6 M0,20 V14"/><rect x="-5" y="6" width="10" height="8"/><path d="M-5,14 L-2.4,6"/>`,
  },
  {
    id: "timer_on", cat: "logic", letter: "K", name: "タイマ (オンディレイ)", nameEn: "On-delay timer",
    desc: "励磁後 t 秒で動作", pins: [{x:0,y:0,n:"A1"},{x:0,y:20,n:"A2"}],
    sim: "coil", bounds: [-13,0, 20, 20], mirror: true, timer: "on",
    body: `<path d="M0,0 V6 M0,20 V14"/><rect x="-5" y="6" width="10" height="8"/><path d="M-12,12.5 A3.6,3.6 0 0 1 -12,7.5" transform="rotate(90 -10.2 10)"/>`,
  },
  {
    id: "timer_off", cat: "logic", letter: "K", name: "タイマ (オフディレイ)", nameEn: "Off-delay timer",
    desc: "消磁後 t 秒で復帰", pins: [{x:0,y:0,n:"A1"},{x:0,y:20,n:"A2"}],
    sim: "coil", bounds: [-13,0, 20, 20], mirror: true, timer: "off",
    body: `<path d="M0,0 V6 M0,20 V14"/><rect x="-5" y="6" width="10" height="8"/><path d="M-12,7.5 A3.6,3.6 0 0 0 -12,12.5" transform="rotate(90 -10.2 10)"/>`,
  },
  {
  ...
  },
  {
    ...
    desc: "カテゴリ3/4 安全回路用", pins: [{x:0,y:0,n:"A1"},{x:0,y:20,n:"A2"}],
    sim: "coil", bounds: [-9,0, 18, 20], mirror: true,
  ...
  },
  {
    ...
    desc: "DIカードの1点", pins: [{x:0,y:0,n:"I"},{x:0,y:20,n:"COM"}],
  ...
  },
  {
    ...
    desc: "DOカードの1点", pins: [{x:0,y:0,n:"Q"},{x:0,y:20,n:"COM"}],
  ...
  /* ══════════ アウトプット機器 ══════════ */
  {
    ...
    desc: "パイロットランプ X1-X2", pins: [{x:0,y:0,n:"X1"},{x:0,y:20,n:"X2"}],
  ...
  },
  {
    ...
    desc: "警報音響機器", pins: [{x:0,y:0,n:"1"},{x:0,y:20,n:"2"}],
  ...
  },
  {
    ...
    desc: "ソレノイドバルブ", pins: [{x:0,y:0,n:"1"},{x:0,y:20,n:"2"}],
    sim: "load", bounds: [-7,0, 14, 20],
  ...
  },
  {
    ...
    desc: "電熱器", pins: [{x:0,y:0,n:"1"},{x:0,y:20,n:"2"}],
  ...
  },
  {
    ...
    body: `<g>${G_NO}</g><g transform="translate(10,0)">${G_NO}</g><g transform="translate(20,0)">${G_NO}</g><path d="M-3,9 L17,9" stroke-dasharray="1.6 1.6" transform="translate(0,0)"/>`,
  },

  /* ══════════ 電源・保護 ══════════ */
  {
    id: "mcb1", cat: "power", letter: "F", name: "サーキットブレーカ 1P", nameEn: "MCB 1-pole",
    desc: "配線用遮断器", pins: [{x:0,y:0,n:"1"},{x:0,y:20,n:"2"}],
    sim: "breaker", bounds: [-9,-2, 12, 24],
    body: G_NO + `<path d="M-1.8,11.2 L1.8,14.8 M-1.8,14.8 L1.8,11.2"/>`,
  },
  {
    ...
    body: `<g>${G_NO}<path d="M-1.8,11.2 L1.8,14.8 M-1.8,14.8 L1.8,11.2"/></g><g transform="translate(10,0)">${G_NO}<path d="M-1.8,11.2 L1.8,14.8 M-1.8,14.8 L1.8,11.2"/></g><g transform="translate(20,0)">${G_NO}<path d="M-1.8,11.2 L1.8,14.8 M-1.8,14.8 L1.8,11.2"/></g><path d="M-3,9 L17,9" stroke-dasharray="1.6 1.6"/>`,
  },
  {
    id: "fuse", cat: "power", letter: "F", name: "ヒューズ", nameEn: "Fuse",
    desc: "溶断保護", pins: [{x:0,y:0,n:"1"},{x:0,y:20,n:"2"}],
    sim: "passthru", bounds: [-5,0, 10, 20],
    body: `<path d="M0,0 V20"/><rect x="-3" y="5" width="6" height="10"/>`,
  },
  {
    id: "psu24", cat: "power", letter: "G", name: "電源ユニット 24VDC", nameEn: "PSU 24VDC",
    desc: "AC100/200V → DC24V", horizontalPins: true,
    pins: [{x:-10,y:0,n:"L"},{x:10,y:0,n:"N"},{x:-10,y:30,n:"+24V"},{x:10,y:30,n:"0V"}],
  ...
  },
  {
    ...
    body: `<path d="M-10,10 V4 M0,10 V4 M10,10 V4"/><path d="M-11.8,6 L-10,2 L-8.2,6 Z M-1.8,6 L0,2 L1.8,6 Z M8.2,6 L10,2 L11.8,6 Z" fill="currentColor"/>`,
  },
  {
    id: "trafo", cat: "power", letter: "T", name: "変圧器", nameEn: "Transformer",
    desc: "制御トランス", pins: [{x:0,y:0,n:"1"},{x:0,y:40,n:"2"}],
    sim: "passthru", bounds: [-9,0, 18, 40],
  ...
  /* ══════════ 端子・その他 ══════════ */
  {
    ...
    desc: "端子台の1点", pins: [{x:0,y:0,n:""},{x:0,y:20,n:""}],
  ...
  },
  {
    ...
    desc: "ページ間の電位接続点", pins: [{x:0,y:0,n:""}],
    sim: "none", bounds: [-10,0, 20, 8],
